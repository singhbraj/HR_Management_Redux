...
import { getEmployees,addEmployee } from '../actions/employeesActions';
...
class view extends Component {
    ...
    preHandle=()=>{
       ...
       this.setState({page:this.state.page-1},()=>{
        ...
        this.props.getEmployees(this.state.page);
       })
...
export default connect(mapStateToProps,{getEmployees,addEmployee})(view)
